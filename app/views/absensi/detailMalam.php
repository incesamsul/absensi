...
$jmlLembur = $jmlLembur - $jmlHMinggu;

$jmlWajibMasuk = $data['jmlHariPerBulan'] - $jmlHSabtu;
...
foreach ($dataAbsensi as $key => $value) {
    ...
    // FOR MALAM
    // for ($i = 0; $i < count($dataAbsensi[$key]['arr_jam']); $i++) {
    //     if (strtotime($dataAbsensi[$key]['arr_jam'][$i]) >= strtotime('18:30') && strtotime($dataAbsensi[$key]['arr_jam'][$i]) <= strtotime('20:30')) {
    //         $dataAbsensi[$key]['jam_masuk'][] = $dataAbsensi[$key]['arr_jam'][$i];
    //     }
    //     if (strtotime($dataAbsensi[$key]['arr_jam'][$i]) >= strtotime('22:50') && strtotime($dataAbsensi[$key]['arr_jam'][$i]) <= strtotime('23:20')) {
    //         $dataAbsensi[$key]['jam_pulang'][] = $dataAbsensi[$key]['arr_jam'][$i];
    //     }
    //     if (strtotime($dataAbsensi[$key]['arr_jam'][$i]) >= strtotime('5:30') && strtotime($dataAbsensi[$key]['arr_jam'][$i]) <= strtotime('10:55')) {
    //         $dataAbsensi[$key]['jam_masuk_lembur'][] = $dataAbsensi[$key]['arr_jam'][$i];
    //     }
    //     if (strtotime($dataAbsensi[$key]['arr_jam'][$i]) >= strtotime('16:25') && strtotime($dataAbsensi[$key]['arr_jam'][$i]) <= strtotime('16:45')) {
    //         $dataAbsensi[$key]['jam_pulang_lembur'][] = $dataAbsensi[$key]['arr_jam'][$i];
    //     }
    // }
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body pt-0">
                                <table class="table table-bordered table-striped">
                                    <tr>
                                        <td>Jumlah Masuk</td>
                                        <td><?= $jmlMasuk + ($jmlLembur < 0 ? 0 : $jmlLembur / 2); ?></td>
                                    </tr>
                                    <tr>
